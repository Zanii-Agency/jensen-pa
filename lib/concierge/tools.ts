...
export const TOOLS: Tool[] = [
  ...
  { name: "set_reminder", description: "Set a reminder that actually PINGS Jensen on WhatsApp at a time. Use this for EVERY 'remind me' request ('remind me in two weeks to message Stéphane', 'remind me Friday about the invoice', 'end of the month remind me to call Nas'). A task does NOT ping him; only this does. If he gives no time, use 09:00. Reply with the exact day, date and time you set, so he can correct it.", input_schema: obj({ what: str("what to remind him about, in his own words"), date: str("YYYY-MM-DD"), time: str("HH:MM Dubai time; 09:00 if he gave none") }, ["what", "date"]) },
  { name: "confirm_pending_action", description: "Answer a held action. Use ONLY when the system prompt shows an OPEN QUESTION and Jensen's message in this turn answers it. confirm:true when he means yes in any words ('stop them', 'go on', 'fine do it'); confirm:false when he means no. Must be your FIRST tool call of the turn. Relay the outcome it returns exactly; if it returns an error, nothing was done.", input_schema: obj({ id: str("the id shown in the OPEN QUESTION"), confirm: bool("true = yes, do it; false = no, leave it") }, ["id", "confirm"]) },
